                        ...
                        <div className="bg-[#D9D9D9] dark:bg-inputDark shadow-lg p-5 rounded-md">
                            <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
                                ...
                                <div className="flex-1">
                                    <h2 className="text-lg font-semibold capitalize dark:text-bodyColor">{tasker?.profile.name}</h2>
                                    
                                    <p className="dark:text-bodyColor ">{tasker?.profile.email}</p>
                                    <div className="mt-5">
                                        <h2 className="text-lg font-semibold dark:text-bodyColor">وصفي :</h2>
                                        <p className="dark:text-bodyColor">{tasker?.bio}</p>
                                    </div>
                                    <div className="mt-5">
                                        <h2 className="text-lg font-semibold dark:text-bodyColor">التقييمات :</h2>
                                        <div>
